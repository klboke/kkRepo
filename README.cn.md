...
6. Swift Package Registry - 规划中，覆盖 hosted、GitHub-backed proxy、group、Swift Registry v1、真实 SwiftPM / Xcode E2E 和 Nexus 迁移（[设计说明](docs/zh/dev/swift-package-registry-design.md)）
