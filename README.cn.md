...
13. R / CRAN - 规划 proxy、hosted 和 group 仓库；hosted 与 group 范围将对齐 Nexus 的 `.gz` package 支持，并把 Cleanup、安全扫描、高效数据库索引和 Nexus 性能门禁纳入验收（[设计说明](docs/zh/dev/r-cran-repository-design.md)）。
