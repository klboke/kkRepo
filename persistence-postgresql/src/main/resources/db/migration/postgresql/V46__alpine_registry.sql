...
CREATE INDEX idx_alpine_package_namespace
  ON alpine_package_record(repository_id, distribution_name, package_name, id);
...
CREATE INDEX idx_alpine_relation_package
  ON alpine_package_relation(repository_id, package_id);
CREATE INDEX idx_alpine_relation_lookup
  ON alpine_package_relation(repository_id, relation_kind, token_hash, package_id);
...
CREATE INDEX idx_alpine_group_stage_cleanup
  ON alpine_group_snapshot_stage(
...
CREATE INDEX idx_alpine_suite_worker
  ON alpine_suite_state(publish_pending, desired_at, repository_id, distribution_name)
  WHERE publish_pending;
CREATE INDEX idx_alpine_suite_force_publish
  ON alpine_suite_state(publish_pending, pending_since, repository_id, distribution_name)
  WHERE publish_pending;
