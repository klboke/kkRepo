...
- Database revision：当前 Grype 漏洞数据库 revision。
...
| `KKREPO_SCANNER_MAX_OUTPUT_BYTES` | `67108864` | scanner 输出上限 |
...
| Database revision 过旧 | 检查自动更新、scanner HTTPS 出站、数据库卷权限和可用空间 |
