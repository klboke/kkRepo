...
| Terraform Provider / Module Registry | hosted / proxy / group | [Terraform 使用示例](../client-recipes.md#terraform-provider--module-registry) | [Terraform 仓库使用指南](terraform.md) |
| Swift Package Registry | hosted / proxy / group | [Swift 使用示例](../client-recipes.md#swift-package-registry) | [Swift Package Registry 使用指南](swift-package-registry.md) |
| Ansible Galaxy | hosted / proxy / group | [Ansible Galaxy 使用示例](../client-recipes.md#ansible-galaxy) | [Ansible Galaxy 仓库使用指南](ansible-galaxy.md) |
| Conda | hosted / proxy / group | [Conda 使用示例](../client-recipes.md#conda) | [Conda 仓库使用指南](conda.md) |
...
| R / CRAN | hosted / proxy / group | [R / CRAN 使用示例](../client-recipes.md#r--cran) | [R / CRAN 仓库使用指南](r-cran.md) |
...
客户端使用示例涵盖常用访问地址、认证方式、发布命令和拉取命令。每份仓库指南还提供仓库创建、
