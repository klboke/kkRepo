...
- 使用方需要逐个修改 CI、构建脚本、Maven settings、npm registry、PyPI index-url、Go proxy、Helm repo、Cargo registry 配置、Pub hosted URL、Composer repository URL、Terraform `host.services`、Ansible Galaxy server URL 等配置。
