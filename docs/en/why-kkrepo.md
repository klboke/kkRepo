...
- CI continues to use the original Maven settings, npm registry, PyPI index-url, Go proxy, Helm repo, Cargo registry config, Pub hosted URL, Composer repository URL, Terraform `host.services` URL, and Ansible Galaxy server URL.
