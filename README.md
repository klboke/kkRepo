...
2. ✅ Artifact security scanning - Implemented behind a disabled-by-default feature flag with SBOM and known-vulnerability scanning for hosted, proxy, and migrated artifacts, Docker/OCI multi-platform scanning, durable database-backed multi-replica coordination, policy/waiver evaluation, Admin UI, and optional download enforcement ([Chinese design notes](docs/zh/dev/security-scanning-design.md)).
