(function () {
  ...
  const zh = {
    ...
    "Form changes appear here automatically. Valid JSON changes update the form immediately.": "表单变更会自动显示在此处；有效的 JSON 修改会立即同步回表单。",
    "Synced": "已同步",
    "Waiting for valid JSON": "等待有效 JSON",
    "Source is system managed. Existing secrets are shown as ********.": "Source 由系统管理；现有密钥以 ******** 显示。",
