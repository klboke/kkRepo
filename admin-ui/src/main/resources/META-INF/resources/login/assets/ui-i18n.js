(function () {
  ...
  const zh = {
    ...
    "Validate size": "校验大小",
    "Capture Nexus public IDs": "采集 Nexus Public ID",
    "Public ID backfill only": "仅回填 Public ID",
    "Optional hosted repositories": "可选 Hosted 仓库",
    "Public ID repositories": "Public ID 仓库",
    "Public ID repositories are required when public ID capture is enabled.": "启用 Public ID 采集时必须指定 Public ID 仓库。",
    ...
    "Public ID mode": "Public ID 模式",
    "Public ID scope": "Public ID 范围",
    "Legacy: all selected repositories": "历史任务：全部已选仓库",
    "Nexus ID mapped assets": "已映射 Nexus ID 的资产",
    "Nexus IDs": "Nexus ID",
    "Backfill only": "仅回填 Public ID",
    "Capture during migration": "迁移时采集",
    "Disabled": "未启用",
