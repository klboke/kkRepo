...
class SecurityScanPoliciesJavascriptTest {
  @Test
  void policyDeletionJavascriptContract() throws Exception {
    assumeTrue(nodeIsAvailable(), "Node.js is required for admin-ui JavaScript tests");

    Process process = new ProcessBuilder(
        "node",
        "--test",
        Path.of("src/test/js/security-scan-policies.test.js").toString())
