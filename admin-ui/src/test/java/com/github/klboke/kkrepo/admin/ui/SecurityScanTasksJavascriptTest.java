...
class SecurityScanTasksJavascriptTest {
  @Test
  void securityScanTasksJavascriptContract() throws Exception {
    assumeTrue(nodeIsAvailable(), "Node.js is required for admin-ui JavaScript tests");

    Process process = new ProcessBuilder(
        "node",
        "--test",
        Path.of("src/test/js/security-scan-tasks.test.js").toString())
