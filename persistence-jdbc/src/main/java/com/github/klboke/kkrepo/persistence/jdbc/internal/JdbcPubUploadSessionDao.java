...
@Repository
public class JdbcPubUploadSessionDao implements com.github.klboke.kkrepo.persistence.jdbc.api.PubUploadSessionDao {
  ...
  public JdbcPubUploadSessionDao(JdbcTemplate jdbcTemplate, JsonColumns jsonColumns) {
